...
<html>
    ...
    <body>
          <script type="text/javascript"> 
				...
				function Validate()
				{
					...
					if(f.email.value.length===0) {error_msg += "No Email Address was entered\n";}
                                        ...
                                        if(emailregex.test(f.email.value) === false){error_msg += "Incorrect email was entered";}
        ...
        <h1 align="center">Enter Registration Details here</h1>
        <form name="myForm" action="registerentry.php" method="post">
