...
<html>
    ...
    <body>
        <form name="myForm" action="finalrename.php" method="post">
...
?>
            ...
            <h1 align="center">Enter the new name for selected library</h1>
              <input type= "text" name="lname" value="" />
                     <input type="submit" value= "Click here to save and continue" id= "update" />  
